...
function printHelp() {
  ...
  echo "    -c <channel name> - channel name to use (defaults to \"evchannel\")"
  ...
  echo
  echo "	byfn.sh generate -c evchannel"
  echo "	byfn.sh up -c evchannel -s couchdb"
  echo "        byfn.sh up -c evchannel -s couchdb -i 1.4.0"
  echo "	byfn.sh up -l node"
  echo "	byfn.sh down -c evchannel"
  echo "        byfn.sh upgrade -c evchannel"
  echo
...
# channel name defaults to "evchannel"
CHANNEL_NAME="evchannel"
