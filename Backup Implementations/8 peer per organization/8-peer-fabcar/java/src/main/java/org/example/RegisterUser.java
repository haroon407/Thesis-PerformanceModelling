...
public class RegisterUser {
	...
	public static void main(String[] args) throws Exception {
		...
		props.put("pemFile",
			"../../8-peers-network/crypto-config/peerOrganizations/org1.example.com/ca/ca.org1.example.com-cert.pem");
		...
		if (!userExists) {
			System.out.println("\"admin\" needs to be enrolled and added to the wallet 8-peers-network");
			return;
		}
